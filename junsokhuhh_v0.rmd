...
![Junsok Huhh](https://anarinsk.github.io/lostineconomics-v2-1/images/title/catandme.jpg){width=%}


Contact Info {#contact}
--------------------------------------------------------------------------------

- <i class="fa fa-envelope"></i> junsokhuhh@ncsoft.com
- <i class="fa fa-envelope"></i> anarinsk@gmail.com
- <i class="fa fa-github"></i> [github.com/anarinsk](https://github.com/anarinsk)
- <i class="fa fa-phone"></i> +82 10-4932-9881
- For more information, please contact me via email.

Skills {#skills}
--------------------------------------------------------------------------------

- Experienced in data analysis, statistical learning models, and data visualization.

- Full experienced in game theory and microeconomic analysis.

- Highly skilled in R, Python, LaTeX
...
### Currently working as a data scientist at NCSOFT Seoul
